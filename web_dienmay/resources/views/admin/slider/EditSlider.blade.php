...
@section('content')
    ...
    <form action="{{route('admin.slider.edit',$slider->id)}}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input value="{{$slider->title}}" type="text" class="form-control" name="title">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" cols="5" rows="5" name="description">{{$slider->description}}</textarea>
